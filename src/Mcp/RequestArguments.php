...
class RequestArguments
{
    ...
    public function value(RequestContext $context, string $name, mixed $fallback): mixed
    {
        ...
        return is_array($arguments) && array_key_exists($name, $arguments) ? $arguments[$name] : $fallback;
    }
    ...
    {
        $decoded = Json::decodeRaw($content);
        ...
        foreach ($messages as $message) {
            ...
            $arguments = Json::objectProperties($message->params->arguments);
